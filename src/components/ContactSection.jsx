...
const contactLinks = [
  {
    ...
    color:
      "bg-rose-50 dark:bg-rose-950/40 text-rose-500 border-rose-100 dark:border-rose-900/40",
  },
  {
  ...
  },
  {
    ...
    color:
      "bg-violet-50 dark:bg-violet-950/40 text-violet-500 border-violet-100 dark:border-violet-900/40",
  },
];
...
const ContactSection = () => {
  ...
  return (
    <section
      id="contacts"
      className="bg-gray-50 dark:bg-gray-950/50 py-24 px-6"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
          <div className="lg:col-span-2">
            <p className="text-[15px] text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
              ...
              interesting collaborations. Whether you have a project in mind or
            ...
            <div className="flex flex-col gap-3 mb-8">
              {contactLinks.map(({ icon, label, value, sub, href, color }) => (
                ...
                >
                  <div
                    className={`w-9 h-9 rounded-lg flex items-center justify-center border flex-shrink-0 ${color}`}
                  >
                    {icon}
                  </div>
                  ...
                  <ArrowUpRight
                    size={13}
                    className="ml-auto text-gray-300 dark:text-gray-600 group-hover:text-gray-500 dark:group-hover:text-gray-400 transition-colors flex-shrink-0"
                  />
                </a>
              ))}
            </div>
